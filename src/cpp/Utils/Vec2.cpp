...
Vec2 &operator*(const int &i, const Vec2 &vec) { return i * vec; }

Vec2 &Vec2::operator+=(const Vec2 &vec) { return this->Add(vec); }

Vec2 &Vec2::operator-=(const Vec2 &vec) { return this->Subtract(vec); }

Vec2 &Vec2::operator*=(const Vec2 &vec) { return this->Multiply(vec); }

Vec2 &Vec2::operator/=(const Vec2 &vec) { return this->Divide(vec); }
